    ...
    <div class="row">
      <div class="card border-info mb-3 mt-4" style="width: 50rem; height: 20rem;">
        <div class="card-header bg-transparent border-info">
          2. Sel darah merah boleh diketegorikan sebagai _________. <!-- question-->
        </div>
                ...
                <tbody> <!--answer-->
                  ...
                  <tr>
                    <td>
                      ...
                      <button type="button" class="btn btn-outline-warning" onclick="window.location.href='QE1.php';">BACK</button>
