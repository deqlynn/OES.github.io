    ...
    <div class="row">
      <div class="card border-info mb-3 mt-4" style="width: 50rem; height: 20rem;">
        <div class="card-header bg-transparent border-info">
          30. Red blood cell indices are used to define _________. <!-- question-->
        </div>
                  ...
                  <tr>
                    <td>
                      <div class=" modal-footer justify-content-end w-100">
                        ...
                        <button type="button" class="btn btn-outline-primary " id="demo" onclick="myExam()">FINISH</button>
                      </div>                    
                    </td>
                  </tr>               
                </tbody>
...
function myExam() {
  var txt;
  if (confirm("Confirm to Finish Exam")) {
    window.location="../LandingPage/finishpage.html";
  } else {
